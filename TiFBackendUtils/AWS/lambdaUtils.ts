...
export const scheduleAWSLambda = async (dateString: string, targetLambdaParams?: any) => {
...
export const invokeAWSLambda = async (lambdaName: string, targetLambdaParams?: any) => {
  const params = {
