...
export interface DBuserRelations {
  'fromUserId': string;
  'status': 'not-friends'|'friends'|'friend-request-pending'|'blocked';
  'toUserId': string;
  'updatedAt'?: Date;
}
...
export interface DBViewEvents {
  ...
  'name': string | null;
  'profileImageURL': string | null;
  'relationHostToUser': 'not-friends'|'friends'|'friend-request-pending'|'blocked' | null;
  'relationUserToHost': 'not-friends'|'friends'|'friend-request-pending'|'blocked' | null;
  'shouldHideAfterStartDate': boolean;
  'startTimestamp': Date;
  'street': string | null;
  'street_num': string | null;
...
export interface DBschema_migrations {
  ...
  'cutover_attempts'?: number;
  'ddl_action'?: string;
  'dropped_no_default_column_names': string;
  'eta_seconds'?: string;
  'expanded_column_names': string;
  'force_cutover'?: boolean;
  'id'?: string;
  'is_immediate_operation'?: boolean;
  'is_view'?: boolean;
  'keyspace': string;
  ...
  'mysql_table': string;
  'options': string;
  'postpone_completion'?: boolean;
  'postpone_launch'?: boolean;
  'progress'?: number;
