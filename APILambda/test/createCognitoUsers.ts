...
export const createCognitoAuthToken = async (
  ...
  console.log(
    "creating the user and about to set the user's profile_created attribute to true for the user ",
    email
  )

  await cognito.adminUpdateUserAttributes(verifyEmailParams).catch((err) => {
    console.error(err)
    throw new Error(err)
  })
...
const users = [
  "Luna61@yahoo.com",
  "Wiley_Wintheiser30@yahoo.com",
  "Ali38@yahoo.com",
  "Kianna5@gmail.com",
  "Jerrell.Ward52@gmail.com",
  "Gayle.DuBuque56@gmail.com",
  "Sylvia_Walter68@gmail.com",
  "Percival_Jacobson46@hotmail.com",
  "Amara69@yahoo.com",
  "Else_Keebler@hotmail.com",
  "Toby.Dickens@yahoo.com",
  "Kayden.Kassulke@gmail.com"
]
const counter = { currentUserIndex: 0 }

export const createCognitoTestAuthToken =
  async (): // TODO: Remove after we get company email so we can have unlimited test users
